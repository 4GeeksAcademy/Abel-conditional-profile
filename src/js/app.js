...
function render(variables = {}) {
  ...
  // cambiando la posicion de los links
  // let SMposition = document.querySelector(".widget>ul");
  // let select = document.querySelector("#SMPosition");
  // console.log(select);
  // console.log(select.value);
  // SMposition.className = select.value;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>
          	${variables.name ||
              "su mama no lo quiso y no le puso nombre 😆"} ${variables.lastName ||
    ""}
          </h1>
          <h2>
              ${variables.role || "vagabundo sin trabajo 😆"}
          </h2>
          <h3>
              ${variables.city || ""}, ${window.variables.country || ""}
          </h3>
